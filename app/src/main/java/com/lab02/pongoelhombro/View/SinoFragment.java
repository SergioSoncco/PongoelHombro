 ...
 * Use the {@link SinoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SinoFragment extends Fragment {
     ...
     * @return A new instance of fragment SinoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SinoFragment newInstance(String param1, String param2) {
        SinoFragment fragment = new SinoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Body = "Sinopharm, Pais:"+t1.getText()+"\n Laboratorio: "+t2.getText()+"\n Sintomas: "+t3.getText();
                String Sub = "Sinopharm, Pais:"+t1.getText()+"\n Laboratorio: "+t2.getText()+"\n Sintomas: "+t3.getText();
